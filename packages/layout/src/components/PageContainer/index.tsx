...
import PageHeader /* , { pageHeaderProps, } */ from '@arco-design/web-vue/es/page-header';
import { Tabs, Affix, Spin } from '@arco-design/web-vue';
import type { ArcoOptions } from '@arco-design/web-vue/es/_utils/types';
import {
  setGlobalConfig,
  getComponentPrefix,
} from '@arco-design/web-vue/es/_utils/global-config';
...
import '@arco-design/web-vue/es/affix/style';
import '@arco-design/web-vue/es/page-header/style';
...
// import { withInstall } from '@arco-design/web-vue/es/_util/types';
...
const PageContainer = Object.assign(_PageContainer, {
  install: (app: App, options?: ArcoOptions) => {
    setGlobalConfig(app, options);
    const componentPrefix = getComponentPrefix(options);

    app.component(componentPrefix + _PageContainer.name, _PageContainer);
  },
});
